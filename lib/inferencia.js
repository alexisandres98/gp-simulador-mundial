...
function mediaIC(valores, { alfa = 0.05 } = {}) {
  ...
  return { n, gl: n - 1, media: r4(m), sd: r4(s), se: r4(se), t: se > 0 ? r4(m / se) : null,
    ic: se > 0 ? [r4(m - z * se), r4(m + z * se)] : [null, null], alfa, aprox: 'cuantil normal, no Student' };
}
