...
(function () {
  ...
  var DICT = {
    es: {
      ...
      lb_txt: 'Dardos y tenis de mesa, recién abiertos: gratis para todos los planes esta semana.', lb_cta: 'Crear cuenta gratis',
      ...
      fq4_q: '¿Qué deportes y ligas cubren?', fq4_a: 'Once, cada uno con su propio motor: fútbol (44 ligas en vivo, de Brasileirão a Liga MX), UFC/MMA y boxeo, tenis ATP y WTA, baloncesto, esports (CS2, League of Legends, Valorant y Dota 2), fútbol americano (NFL, College y CFL), Fórmula 1, dardos (PDC) y tenis de mesa (circuito WTT). Los dos últimos acaban de abrir.',
      ...
      a_micro: 'Once deportes · sin tarjeta · sin spam',
    ...
    en: {
      ...
      lb_txt: 'Darts and table tennis just opened: free on every plan this week.', lb_cta: 'Create free account',
      ...
      fq4_q: 'Which sports and leagues?', fq4_a: 'Eleven, each with its own engine: football (44 live leagues, from Brasileirão to Liga MX), UFC/MMA and boxing, ATP and WTA tennis, basketball, esports (CS2, League of Legends, Valorant and Dota 2), American football (NFL, College and CFL), Formula 1, darts (PDC) and table tennis (WTT tour). The last two have just opened.',
      ...
      a_micro: 'Eleven sports · no card · no spam',
