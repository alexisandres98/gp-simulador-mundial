...
(function () {
  ...
  function shell() {
    ...
    $('#gx-root').innerHTML =
      ...
      '<div class="gx-search">' + ic('search') + '<input id="gx-search-i" autocomplete="off" spellcheck="false" placeholder="' + esc(t(S.sport === 'combat' ? 'cb_search_top' : 'search')) + '"><div class="gx-search-res" id="gx-search-res" hidden></div></div>' +
